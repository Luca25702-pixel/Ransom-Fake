...
echo MsgBox "Windows is in crash state and the kernel is unavalabile!" ^& vbCrLf ,262192, "Title"> corruption.vbs
echo MsgBox "turn off nowf avoiding any corruption!" ^& vbCrLf ,262192, "Title"> corruption.vbs
dism C: /d
